...
const { createSession: createSupabaseSession } = useSupabaseSession()
...
const createSession = async () => {
  ...
  try {
    ...
    const oembedUrl = `https://www.youtube.com/oembed?url=${encodeURIComponent(youtubeUrl.value)}&format=json`
    ...
    sessionData.value = await createSupabaseSession(
      youtubeUrl.value,
      metadata.title || null,
